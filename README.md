...
This project was implemented using [Python 3](https://www.python.org/downloads/). The list of required packages can be found in `requirements.txt`. To install them, run the following command from the root directory of this project (preferably in a venv).
